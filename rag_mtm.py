...
def preprocess_query(query):
    ...
    INSTRUCTION = f"### Instruction\n Respond to the following query by your admirer, '{query}'.Be like yourself when responding. If You don't know an answer just say I am not aware.\n\n"
...
sql_generator.launch(server_port=9000, share=True)